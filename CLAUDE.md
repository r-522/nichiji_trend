...
| 20260612 | fable-effort-lab | TypeScript | Claude Fable 5 / Mythos 5 (Mythosクラスモデル) / effortパラメータ・refusal stop reason・新トークナイザ (Anthropic API) |

> **次回の言語選定メモ**: 直近（20260612）の使用言語は **TypeScript**。翌日は TypeScript 以外の言語を選定すること。
