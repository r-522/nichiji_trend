...
| 20260606 | skillsmith | TypeScript | Agent Skills オープン標準 (SKILL.md) / 仕様検証・lint・レジストリ生成 CLI（依存ゼロ・自前YAMLフロントマターパーサ） |

> **次回の言語選定メモ**: 直近（20260606）の使用言語は **TypeScript**。翌日は TypeScript 以外の言語を選定すること。
