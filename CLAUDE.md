...
| 20260601 | gguf-inspector | Rust | オンデバイス LLM 推論 / GGUF v3 フォーマット (llama.cpp 互換量子化モデルコンテナ) |

> **次回の言語選定メモ**: 直近（20260601）の使用言語は **Rust**。翌日は Rust 以外の言語を選定すること（直近の使用言語: Python / Go / Rust）。
